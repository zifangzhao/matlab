...
while plotting_on
    ...
    a=readmulti_frank(filename,1,1,-display_time*2*fs*N_channel,0,'int16');
    ff=dir(filename);
    set(handles.figure1,'Name',['Recording...' num2str(ff.bytes./fs/N_channel)]);
    a_bin=dec2bin(a(1:length(selected_channel))+32768,16);
%     counter=0:31;
