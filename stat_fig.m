...
% Last Modified by GUIDE v2.5 14-Apr-2012 16:27:38
...
set(handles.listbox2,'String',map_all{selected_attr}');
set(handles.listbox2,'Max',size(map_all{selected_attr},2));
...
global selected_attr selected_index1 selected_index2;
varargout{1}=[];%handles.output;
varargout{2}=selected_attr;
varargout{3}=selected_index1;
varargout{4}=selected_index2;
...
set(handles.listbox2,'String',map_all{selected_attr}');
set(handles.listbox2,'Max',size(map_all{selected_attr},2)-1);
...
global selected_index1 map_all selected_attr;
selected_index1=[];
selected_value=get(handles.listbox1,'Value');
string1=get(handles.listbox1,'String');
selected_string1=string1(selected_value);
for idx=1:length(selected_value)
    selected_index1=[selected_index1 find(strcmp(map_all{selected_attr},selected_string1{idx}))];
end
...
global selected_index2 map_all selected_attr;
selected_index2=[];
selected_value=get(handles.listbox2,'Value');
string2=get(handles.listbox2,'String');
selected_string2=string2(selected_value);
for idx=1:length(selected_value)
    selected_index2=[selected_index2 find(strcmp(map_all{selected_attr},selected_string2{idx}))];
end
