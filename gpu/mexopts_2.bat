...
set PATH=%MW_NVCC_PATH%;%VCINSTALLDIR%\bin\amd64;%VCINSTALLDIR%\bin;%VCINSTALLDIR%\VCPackages;%VSINSTALLDIR%\Common7\IDE;%VSINSTALLDIR%\Common7\Tools;%LINKERDIR%\bin\x64;%LINKERDIR%\bin;C:\Program Files\Microsoft SDKs\Windows\v6.0A\Bin;%MATLAB_BIN%;%PATH%
...
set LIB=%VCINSTALLDIR%\LIB\amd64;%VCINSTALLDIR%\ATLMFC\LIB\amd64;%LINKERDIR%\lib\x64;%MATLAB%\extern\lib\win64;C:\Program Files\Microsoft SDKs\Windows\v6.0A\Lib\x64;%LIB%;%CUDA_LIB_PATH%
...
rem ********************************************************************
set COMPILER=nvcc
set COMPFLAGS=-gencode=arch=compute_13,code=sm_13 -gencode=arch=compute_20,code=sm_20 -gencode=arch=compute_30,code=\"sm_30,compute_30\" -c --compiler-options=/GR,/W3,/EHs,/D_CRT_SECURE_NO_DEPRECATE,/D_SCL_SECURE_NO_DEPRECATE,/D_SECURE_SCL=0,/DMATLAB_MEX_FILE,/nologo,/MD -Xcompiler "/wd 4819"
