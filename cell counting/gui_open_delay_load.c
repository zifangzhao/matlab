 ...
 */
FARPROC WINAPI gui_openDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = gui_openDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = gui_openDelayLoadWin32FailureHook;
#endif
