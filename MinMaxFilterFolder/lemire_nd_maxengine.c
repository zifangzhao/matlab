 ...
 *
 * Compilation:
 *  >> mex -O -R2018a lemire_nd_maxengine.c 
...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    switch (ClassID) {
        ...
        case mxLOGICAL_CLASS:
             adata       = mxGetUint8s(A);
             valdata     = mxGetUint8s(MAXVAL);
             SCAN(auint08, valuint08, uint08);
             break;
        case mxINT8_CLASS:
             adata       = mxGetInt8s(A);
             valdata     = mxGetInt8s(MAXVAL);
