function [phasedistros,phasebins,phasestats,h] = PhaseModulation_frank(spikes,lfp,passband,intervals,lfpfreq,method,plotting)
% USAGE
...
%             hax = subplot(1,2,1); 
            rose(spkphases{a})
            title(['Cell #' num2str(a) '. Rayleigh p = ' num2str(phasestats.p(a)) '.'])
...
%         hax = subplot(1,2,1); 
%         rose(cum_spkphases)
%         title(['All Spikes/Cells Accumulated. Rayleigh p = ' num2str(cps.p) '.'])
