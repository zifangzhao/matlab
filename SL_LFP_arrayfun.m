function SL_comp=SL_LFP_arrayfun(rawdata_valid,system_fs,starts,ends,chans,LP,HS,n_rec,p_ref,stps,delays)
...
%             clear('rawdata_filtered')
            [m,n]=meshgrid(1:channels_len);
            SL{trial}=arrayfun(@(x,y) SL_single(channels{x},channels{y},w1,w2,embedding,sampling_delay,p_ref,stps,delays),m,n,'UniformOutput',0);
