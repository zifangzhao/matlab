...
% for i=1:Lop
%     for j=1:Lop
%         OPxy(i,j)=sum((OPyI==i.*OPxI==j));
%         OPdyy(i,j)=sum((OPyI==i.*OPdyI==j));
%         OPdxx(i,j)=sum((OPxI==i.*OPdxI==j));
%         for k=1:Lop
%         OPdyxy(i,j,k)=sum((OPyI==i.*OPxI==j.*OPdyI==k));
%         OPdxyx(i,j,k)=sum((OPxI==i.*OPyI==j.*OPdxI==k));
%         end
%     end
% end
% toc
